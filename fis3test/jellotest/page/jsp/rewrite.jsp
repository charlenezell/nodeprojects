...
<span class="k">%&gt;</span>
        ...
        <p><a href="hello/testpage" target="_blank">示例</a></p>

        <h2>json 页面模拟</h2>

        <p>关于json 页面，其实可以用 jsp 页面模拟，如<a href="hello/jsp" target="_blank">示例</a>，也可以直接在预览 json 文件，只要此文件放在 test 目录下面。如<a href="hello/json" target="_blank">示例</a>。注意查看 <code>jello-demo</code> 项目下面的 test 目录和 server.conf 文件内容。</p>
