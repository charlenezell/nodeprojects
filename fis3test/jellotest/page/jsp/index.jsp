...
<fis:extends name="/page/layout/2columns-with-left-sidebar.jsp">
    ...
    <fis:block name="content">
        ...
        <p>请先阅读 <a href="hello/doc/standard">jello 中目录规范</a>，虽然文中的提及的模板是velocity，但是同时适用与 jsp</p>
...
&lt;/<span class="pl-ent">fis:html</span>&gt;</pre></div>
    ...
    <h3>fis:widget</h3>
<p>引入一个模板碎片文件，支持指定局部变量。更多信息请查看此处<a href="hello/jsp/widget">说明</a>。</p>

<h3>fis:extends &amp; fis:block &amp; fis:parent</h3>

<p>请查看<a href="hello/jsp/layout">模板继承说明</a>。</p>
