define('components/jquery-ui/droppable', ['require', 'exports', 'module', 'components/jquery/jquery', 'components/jquery-ui/core', 'components/jquery-ui/widget', 'components/jquery-ui/mouse', 'components/jquery-ui/draggable'], function(require, exports, module) {
  ...
  (function (factory) {
      ...
      module.exports = factory(require('components/jquery/jquery'), require('components/jquery-ui/core'), require('components/jquery-ui/widget'), require('components/jquery-ui/mouse'), require('components/jquery-ui/draggable'));;
  }(function ($) {
      $.widget('ui.droppable', {
          version: '1.11.2',
