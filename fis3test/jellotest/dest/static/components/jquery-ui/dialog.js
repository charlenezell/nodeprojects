define('components/jquery-ui/dialog', ['require', 'exports', 'module', 'components/jquery/jquery', 'components/jquery-ui/core', 'components/jquery-ui/widget', 'components/jquery-ui/button', 'components/jquery-ui/draggable', 'components/jquery-ui/mouse', 'components/jquery-ui/position', 'components/jquery-ui/resizable'], function(require, exports, module) {
  ...
  (function (factory) {
      ...
      module.exports = factory(require('components/jquery/jquery'), require('components/jquery-ui/core'), require('components/jquery-ui/widget'), require('components/jquery-ui/button'), require('components/jquery-ui/draggable'), require('components/jquery-ui/mouse'), require('components/jquery-ui/position'), require('components/jquery-ui/resizable'));;
  }(function ($) {
