...
<html lang="en">
<head>
    <title>Code coverage report for datef/datef.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">datef/datef.js</span></h1>
    <h2>
        
        Statements: <span class="metric">92.86% <small>(91 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">79.66% <small>(47 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">94.87% <small>(37 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">92.86% <small>(91 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">datef/</a> &#187; datef.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            return factory(root);</span>
        });
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof exports === 'object') {
        module.exports = factory(root);
    } else {
<span class="cstat-no" title="statement not covered" >        root.datef = factory(root);</span>
    }
}(this, function (root) {
    'use strict';
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (str.length &gt; finalLen) {
...
&nbsp;
    var tokens = {
        ...
        hh: function (date) {
            return leadingZeroes(date.getHours() % 12 || <span class="branch-1 cbranch-no" title="branch not covered" >12)</span>;
        },
        h: function (date) {
            return date.getHours() % 12 || <span class="branch-1 cbranch-no" title="branch not covered" >12;</span>
        },
        mm: function (date) {
        ...
        ZZ: function (date, format, separator) {
            var tz = date.getTimezoneOffset(),
                ...
                mins = tz % 60,
                sign = tz &gt; 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >'-' </span>: '+';
&nbsp;
            separator = separator || '';
&nbsp;
...
&nbsp;
    ...
    for (var extractor in tokens) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (tokens.hasOwnProperty(extractor)) {
...
&nbsp;
        if (!options) {
            ...
            } else <span class="missing-if-branch" title="else path not taken" >E</span>if (hasModule) {
                try {
                    require('./lang/' + lang);
                    languages.current = lang;
                } catch (e) {
...
&nbsp;
    ...
    lang('en', {
        ...
        meridiem : function (hours, isLower) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (hours &gt; 11) {
...
&nbsp;
     ...
     * @return {datef}
     */
    datef.noConflict = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >        root.datef = prevDatef;</span>
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Dec 15 2014 14:26:44 GMT+0500 (YEKT)</div>
</div>
